...
public class LoginUserAdminView extends JFrame{
								...
								.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
										.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
											...
											.addComponent(txtUsuario, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE))
										.addComponent(txtPassword, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
	...
	private boolean checkPassword() {
		if((txtPassword.getText().equals(""))) {
			JOptionPane optionPane = new JOptionPane("Campo contrase�a requerido", JOptionPane.ERROR_MESSAGE);    
			JDialog dialog = optionPane.createDialog(this, "Advertencia");
			dialog.setAlwaysOnTop(true);
			dialog.setVisible(true);
	...
	private void adminLoginInput() {
		if (presenter.adminLogin(txtUsuario.getText(), txtPassword.getText())) {
			...
			JOptionPane optionPane = new JOptionPane("El usuario no existe o la constrase�a es incorrecta", JOptionPane.ERROR_MESSAGE);    
