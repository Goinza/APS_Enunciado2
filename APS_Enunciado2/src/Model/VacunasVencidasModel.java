...
public class VacunasVencidasModel {
	private ResultSet query_vista_aplicadas;
	private ResultSetMetaData md;
	private int cantColumnas;
	//private Filtro filtro;
	
	public VacunasVencidasModel()
	{
		//this.filtro = new SinFiltro();
		executeQuery();
	}
	
	/*public VacunasVencidasModel(Filtro filtro)
	{
		this.filtro = filtro;
		updateQuery();
	}*/
	...
	public void executeQuery() {
		...
		query_vista_aplicadas = database.realizarConsulta("SELECT * FROM Vacunas_Vencidas;");
		try
		{
